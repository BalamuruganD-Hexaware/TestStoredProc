...
using TestStoredProc.Api.Filters;
using TestStoredProc.BusinessServices.Installer;

namespace TestStoredProc.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "TestStoredProc API", Version = version + "-" + branch});
            });
